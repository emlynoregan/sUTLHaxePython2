...
class Sutl:
	...
	def _evaluateEval(self,needseval,s,t,l,src,tt,b,h):
		...
		if needseval:
			...
			haxe_Log.trace("!!!!!!!!!!!!!!!!!!!!!!!",_hx_AnonObject({'fileName': "Sutl.hx", 'lineNumber': 880, 'className': "Sutl", 'methodName': "_evaluateEval"}))
			teval = t
		t2 = Util3.get(teval,"!")
		s2 = _hx_AnonObject({})
		if Util2.isObject(s):
...
class TestsGet(haxe_unit_TestCase):
	...
	def testGetArray(self):
		...
		obj = haxe_ds_StringMap()
		obj = python_lib_Json.loads("[{\"fred\": 2}]",**python__KwArgs_KwArgs_Impl_.fromT(_hx_AnonObject({'object_hook': python_Lib.dictToAnon})))
		result = Util3.get(obj,"fred","isarray")
	...
	def testGetSimple(self):
		...
		result = Util3.get(obj,"fred","isnumber")
	...
	def testGetNull(self):
		...
		result = Util3.get(obj,"fred","isnull")
...
class Tests_Builtins(haxe_unit_TestCase):
	...
	def callbuiltin2(self,builtinname,scope,expected):
		s = Sutl()
		builtins = s.builtins()
		f = Util3.get(builtins,builtinname)
...
class Tests_Decls(haxe_unit_TestCase):
	...
	def EvaluateTransform(self,aDecl,aLibDecls,aSource = None):
		...
		lresult = s.evaluate(aSource,Util3.get(aDecl,"transform-t"),llib,0)
		return lresult

	def EvaluateTransform2(self,aDecl,aLib,aSource = None):
		s = Sutl()
		lresult = s.evaluate(aSource,Util3.get(aDecl,"transform-t"),aLib,0)
		return lresult
